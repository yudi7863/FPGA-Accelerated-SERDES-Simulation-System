...
create_clock -name actual_clock -period 20.000ns [get_ports CLOCK_50]
#create_clock -name actual_clock -period 20.000 -waveform {0 10} [get_ports {CLOCK_50}]
...
# Set Input Delay
#**************************************************************
set_input_delay -clock {actual_clock} -max 2 [all_inputs] 
set_input_delay -clock {actual_clock} -min 1 [all_inputs] 
...
set_output_delay -clock {actual_clock} 0.01 [all_outputs]
