...
module NIOS_UART_mm_interconnect_0 (
		...
		input  wire        on_chip_mem_reset1_reset_bridge_in_reset_reset, // on_chip_mem_reset1_reset_bridge_in_reset.reset
	...
	wire         cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> on_chip_mem_s1_agent:cp_valid
	wire  [92:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> on_chip_mem_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // on_chip_mem_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [2:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> on_chip_mem_s1_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> on_chip_mem_s1_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> on_chip_mem_s1_agent:cp_endofpacket
	...
	wire  [92:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> uart_0_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // uart_0_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [2:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> uart_0_s1_agent:cp_channel
	...
	wire         on_chip_mem_s1_agent_rp_valid;                                                      // on_chip_mem_s1_agent:rp_valid -> router_003:sink_valid
	wire  [92:0] on_chip_mem_s1_agent_rp_data;                                                       // on_chip_mem_s1_agent:rp_data -> router_003:sink_data
	wire         on_chip_mem_s1_agent_rp_ready;                                                      // router_003:sink_ready -> on_chip_mem_s1_agent:rp_ready
	wire         on_chip_mem_s1_agent_rp_startofpacket;                                              // on_chip_mem_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         on_chip_mem_s1_agent_rp_endofpacket;                                                // on_chip_mem_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [92:0] uart_0_s1_agent_rp_data;                                                            // uart_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire         on_chip_mem_s1_agent_rdata_fifo_src_valid;                                          // on_chip_mem_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] on_chip_mem_s1_agent_rdata_fifo_src_data;                                           // on_chip_mem_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         on_chip_mem_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_001:in_0_ready -> on_chip_mem_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> on_chip_mem_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> on_chip_mem_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                                  // on_chip_mem_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> on_chip_mem_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (on_chip_mem_reset1_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                   //             clk.clk
		.reset                   (on_chip_mem_reset1_reset_bridge_in_reset_reset),  //       clk_reset.reset
	...
	NIOS_UART_mm_interconnect_0_router router_001 (
	...
	NIOS_UART_mm_interconnect_0_router_002 router_003 (
	...
	NIOS_UART_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_UART_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (on_chip_mem_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_UART_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_UART_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (on_chip_mem_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_UART_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (on_chip_mem_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_UART_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_UART_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (on_chip_mem_reset1_reset_bridge_in_reset_reset), // in_rst_0.reset
